...
class SubsequenceProvider {
  constructor (options = {}) {
    ...
    // make this.X available where X is the autocomplete-plus-tmp.X setting
    const settings = [
      'autocomplete-plus-tmp.enableExtendedUnicodeSupport', // TODO
      'autocomplete-plus-tmp.minimumWordLength',
      'autocomplete-plus-tmp.includeCompletionsFromAllBuffers',
      'autocomplete-plus-tmp.useLocalityBonus',
      'autocomplete-plus-tmp.strictMatching'
    ]
