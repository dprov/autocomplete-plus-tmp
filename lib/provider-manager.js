...
class ProviderManager {
  ...
  initialize () {
    ...
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.enableBuiltinProvider', value => this.toggleDefaultProvider(value)))
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.scopeBlacklist', value => this.setGlobalBlacklist(value)))
  }
