...
export default class ProviderMetadata {
  constructor (provider, apiVersion) {
    ...
    if (this.provider.providerblacklist && this.provider.providerblacklist['autocomplete-plus-tmp-fuzzyprovider']) {
      providerBlacklist = this.provider.providerblacklist['autocomplete-plus-tmp-fuzzyprovider']
    }
