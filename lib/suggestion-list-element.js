...
module.exports = class SuggestionListElement {
  constructor (model) {
    ...
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.suggestionListFollows', suggestionListFollows => {
      this.suggestionListFollows = suggestionListFollows
    }))
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.maxVisibleSuggestions', maxVisibleSuggestions => {
      this.maxVisibleSuggestions = maxVisibleSuggestions
    }))
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.useAlternateScoring', useAlternateScoring => {
      this.useAlternateScoring = useAlternateScoring
    }))
    this.subscriptions.add(atom.config.observe('autocomplete-plus-tmp.moveToCancel', moveToCancel => {
